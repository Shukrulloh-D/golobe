    ...
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.actions}>
          ...
          <button className={styles.iconBtn} style={{ color: liked ? 'var(--red)' : 'inherit' }} onClick={() => { setLiked(!liked); toast(liked ? 'Removed' : 'Added to favourites'); }}>{liked ? '♥' : '♡'}</button>
          <button className={styles.iconBtn} onClick={() => toast('Link copied to clipboard!')}>⤴</button>
      ...
      <div className={styles.sectionTitle}>
        ...
        <div className={styles.classes}>
          <label><input type="radio" name="class" checked={cls === 'economy'} onChange={() => setCls('economy')} /> Economy</label>
          <label><input type="radio" name="class" checked={cls === 'first'} onChange={() => setCls('first')} /> First Class</label>
          <label><input type="radio" name="class" checked={cls === 'business'} onChange={() => setCls('business')} /> Business Class</label>
        </div>
      </div>
